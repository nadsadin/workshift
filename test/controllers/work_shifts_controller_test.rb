...
class WorkShiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_shift" do
    assert_difference('WorkShift.count') do
      post work_shifts_url, params: { work_shift: { employee_id: @work_shift.employee_id, end_time: @work_shift.end_time, location_id: @work_shift.location_id, rate_id_integer: @work_shift.rate_id_integer, start_time: @work_shift.start_time } }
    end
  ...
  test "should update work_shift" do
    patch work_shift_url(@work_shift), params: { work_shift: { employee_id: @work_shift.employee_id, end_time: @work_shift.end_time, location_id: @work_shift.location_id, rate_id_integer: @work_shift.rate_id_integer, start_time: @work_shift.start_time } }
